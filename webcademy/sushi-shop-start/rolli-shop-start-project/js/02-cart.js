// // Тут код из прошлого урока, но мы добавим фичу, чтобы при добавлении товара, который уже есть в корзине, карточка с ним не добавлялась снова, а увеличивался счетчик на вновь указанное количество товара
	...
	if (event.target.hasAttribute("data-cart")) {
		...
		if (goodsInCart) {
			...
			cartCounter.innerText =
				parseInt(productInfo.quantity) + parseInt(cartCounter.innerText);
		} else {
			const cartItemHtml = `
<!-- Cart item -->
<div class="cart-item" data-id=${productInfo.id}>
